...
- `DiaryViewModel` owns cleanup helpers for captured local `.caf` diary recordings so draft cancellation and existing-entry replacement do not leave unreachable files.
