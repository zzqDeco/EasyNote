...
enum AIContentConsentPolicy {
    ...
    static let requiredMessage = "请先在设置中阅读并允许将日记或转写文本发送给 DeepSeek。"
    static let disclosure = "使用 AI 功能时，EasyNote 会将你选择处理的日记或语音转写文本发送给 DeepSeek。录音音频文件和 API 密钥不会作为 AI 内容发送；API 密钥仅在 Authorization 请求头中用于鉴权。"
}
