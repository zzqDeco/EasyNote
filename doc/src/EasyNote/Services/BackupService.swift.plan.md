...
- Unit tests cover encode/decode, export shape, audio export/restore, invalid backup rejection, no-write failure behavior, upsert import behavior, orphaned message exclusion, app-compatible blank titles, and preserved local message timestamps.
