...
- Upsert same-ID SwiftData records and keep local records that are not present in the backup.
...
- Unit tests cover DTO encode/decode, export data shape, audio export/restore, unsupported version, invalid audio base64, import upsert, and failed-import no-write behavior.
