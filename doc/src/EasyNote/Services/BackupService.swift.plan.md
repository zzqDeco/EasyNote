...
- `BackupLimits.default` caps raw files at 64 MiB, one audio asset at 16 MiB, aggregate audio at 48 MiB, diaries at 10,000, todos at 50,000, sessions at 5,000, messages at 100,000, and audio assets at 500.
...
- Existing deterministic targets are copied into rollback storage before overwrite. File-commit or SwiftData-save failure restores the prior filesystem state and rolls back the `ModelContext`.
