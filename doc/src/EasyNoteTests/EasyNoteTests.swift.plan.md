...
- Current tests cover AI action result success/failure records, per-target/source pending state, stale pending cleanup after failures, source-bound diary summary application, and explicit diary/transcription application behavior.
