...
- Manual smoke:
  ...
  - switch from system Reminders mode to EasyNote notifications and confirm the EasyNote-marked Apple Reminder is removed before local notifications own future alerts
